...
* [x] **Test Suite (Web)**: `/Volumes/shared_code/code_shared/portal/agency_research/dev_tools/test_web_frontend/tests/`
* [x] **Test Runner Script**: `/Volumes/shared_code/code_shared/portal/agency_research/dev_tools/test_web_frontend/run.sh`
* [x] **Mobile Tests**: `/Volumes/shared_code/code_shared/portal/agency_research/code/variant_dashboard/test/`
* [x] **OpenAPI Client Generator**: `/Volumes/shared_code/code_shared/portal/agency_research/dev_tools/package_form_open_api/build.sh`
...
[here](/Volumes/shared_code/code_shared/portal/agency_research/dev_tools/test_web_frontend/tests/application_owner_status_update.test.ts)
