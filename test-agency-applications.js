// Simple JavaScript test for AgencyApplicationsService
// Run with: docker exec nest_server node test-agency-applications.js
...
async function testAgencyApplications() {
  ...
  try {
    ...
    // Get the service - need to import the module first
    const { AgencyApplicationsService } = require('./dist/modules/agency/agency-applications.service');
    ...
    if (result.applications.length > 0) {
      ...
      console.log(`  Position: ${position ? position.title : 'N/A'}`);
      ...
      console.log(`  Applied: ${firstApp.created_at}\n`);
    }
