...
export async function bootstrapDomainWithApplicationTestModule(): Promise<{
  ...
  // Seed baseline countries and titles
  ...
  return { moduleRef, jobs, expenses, interviews, agencies, owners, countries, titles, apps };
}
